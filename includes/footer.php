...
$hubLinks = [
    $baseUri . '/bolge/alsancak-bayrakli'   => 'Alsancak & Bayraklı',
    $baseUri . '/bolge/karsiyaka-cigli'     => 'Karşıyaka & Çiğli',
    $baseUri . '/bolge/gaziemir-havalimani' => 'Gaziemir & Havalimanı',
];
$useCaseLinks = [
    $baseUri . '/kullanim/mesai-sonrasi'        => 'Mesai sonrası ulaşım',
    $baseUri . '/kullanim/yonetici-transferi'   => 'Yönetici transferleri',
    $baseUri . '/kullanim/havalimani-transferi' => 'Havalimanı transferi',
    $baseUri . '/kullanim/toplanti-is-ulasimi'  => 'Toplantı & iş ulaşımı',
    $baseUri . '/kullanim/kucuk-ekip-ulasimi'   => 'Küçük ekip ulaşımı',
    $baseUri . '/kullanim/evrak-paket'          => 'Evrak & küçük paket',
];
$fleetLinks = [
    $baseUri . '/filo/togg'             => 'TOGG',
    $baseUri . '/filo/ford-explorer'    => 'Ford Explorer',
    $baseUri . '/filo/tourneo-custom'   => 'Tourneo Custom',
];
$corpLinks = [
    $baseUri . '/hakkimizda' => 'Hakkımızda',
    $baseUri . '/rehber'     => 'Rehber',
    $baseUri . '/iletisim'   => 'İletişim',
    $baseUri . '/kvkk'       => 'KVKK',
    $baseUri . '/cerez'      => 'Çerez Politikası',
];
?>
</main>
    ...
    <div>
      ...
      <ul>
        <?php foreach ($fleetLinks as $href => $label): ?>
          <li><a href="<?= e($href) ?>"><?= e($label) ?></a></li>
        <?php endforeach; ?>
        <li><a href="/design-4/yonetim-paneli">Yönetim Paneli</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul>
        <?php foreach ($hubLinks as $href => $label): ?>
          <li><a href="<?= e($href) ?>"><?= e($label) ?></a></li>
        <?php endforeach; ?>
        <li><a href="/design-4/hizmet-bolgeleri">Tüm İzmir ilçeleri</a></li>
      </ul>
    </div>
  ...
  <div class="lead-modal__panel" role="dialog" aria-modal="true" aria-labelledby="leadModalTitle">
    ...
    <form id="leadForm" data-validate novalidate>
      ...
      <label class="form-consent">
        ...
        <span><a href="/design-4/kvkk">KVKK aydınlatma metnini</a> okudum, iletişim için verdiğim bilgilerin işlenmesini onaylıyorum.</span>
      </label>
